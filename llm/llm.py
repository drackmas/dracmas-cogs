...
class OpenLumara(commands.Cog):
    ...
    async def on_message_without_command(self, message: discord.Message):
        ...
        # Also ensures the message text starts with or strictly contains the tag cleanly
        ...
        # Handles both normal mentions <@id> and nickname mentions <@!id>
